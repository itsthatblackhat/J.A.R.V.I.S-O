...
class NoradrenergicSystem:
    def __init__(self, number_of_neurons):
        self.neurons = [NoradrenergicNeuron() for _ in range(number_of_neurons)]
...
if __name__ == "__main__":
    norad_system = NoradrenergicSystem(number_of_neurons=100)
    input_data = [1, 2, 3, 4, 5]  # Just an example, real data would be more complex
    norad_system.receive_input(input_data)
    norepinephrine_level = norad_system.release_norepinephrine_to_brain()
