...
class GlutamatergicSynapse:
    ...
    def release_neurotransmitter(self):
        """
        Release glutamate from the presynaptic neuron.
        """
        if self.pre_neuron.firing_state:  # If the pre-synaptic neuron is firing
            ...
            self.post_neuron.receive_neurotransmitter('glutamate', release_amount)
...
# ... Additional functions and utility methods for the glutamatergic synapse.
