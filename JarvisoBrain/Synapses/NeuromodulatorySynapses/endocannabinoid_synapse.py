...
if __name__ == "__main__":
    endoc_system = EndocannabinoidSystem(number_of_neurons=100)
    input_data = [1, 2, 3, 4, 5]  # Just an example, real data would be more complex
    endoc_system.receive_input(input_data)
    endocannabinoid_level = endoc_system.release_endocannabinoids_to_brain()
